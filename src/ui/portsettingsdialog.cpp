...
PortSettingsDialog::PortSettingsDialog( QString name, QWidget* parent )
  ...
  connect( ui->btn_defaults,
           &QPushButton::clicked,
           this,
           &PortSettingsDialog::resetSerialPort );
}
...
void PortSettingsDialog::resetSerialPort() {
...
void PortSettingsDialog::selectByData( QComboBox* box, int dataValue ) {
...
void PortSettingsDialog::populateBaudRate( QComboBox*   box,
                                           BaudRateType initialValue ) {
#ifdef Q_OS_UNIX
...
void PortSettingsDialog::populateDataBits( QComboBox*   box,
                                           DataBitsType initialValue ) {
...
void PortSettingsDialog::populateParity( QComboBox* box,
                                         ParityType initialValue ) {
...
void PortSettingsDialog::populateStopBits( QComboBox*   box,
                                           StopBitsType initialValue ) {
...
void PortSettingsDialog::populateFlowControl( QComboBox* box,
                                              FlowType   initialValue ) {
