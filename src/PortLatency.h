 ...
 * Implementation varies from OS to OS. Implementation has to determine if port
 * referred to by "portName" actually is an FTDI device or not.
 *
...
#ifdef Q_OS_WIN32
  bool switchLatency( HKEY           paramKey,
